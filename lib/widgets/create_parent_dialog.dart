...
class CreateParentDialog extends StatefulWidget {
  const CreateParentDialog({super.key});

  @override
  State<CreateParentDialog> createState() => _CreateParentDialogState();
}
...
class _CreateParentDialogState extends State<CreateParentDialog> {
  ...
  Future<void> _submit() async {
    ...
    final success = await userService.createParent({
      'name': _nameController.text.trim(),
      'phoneNumber': _phoneController.text.trim(),
      'password': _passwordController.text,
      'status': _status,
      // 'children': [] // Can add children selection later
    });
    ...
    if (mounted) {
      ...
      if (success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Failed to create parent')),
        );
      }
    }
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Add a new parent to your organization',
